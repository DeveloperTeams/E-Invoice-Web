    ...
    <div className="result-container">
      <div className="result-header">
        <div className="result-header-left">
          <div className="success-badge yolo-badge">
          ...
          <h2 className="result-title">Invoice Data Extracted (YOLO)</h2>
        </div>
        ...
        <div className="result-card full-width">
          ...
          <div className="card-content">
            ...
            <div className="info-row">
              ...
              <span className="info-value">
                <span className="method-badge yolo">{processingInfo.detection_method}</span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="result-card">
          ...
          <div className="card-content">
            ...
            <div className="info-row">
              ...
              <span className="info-value">{processingInfo.provider || 'N/A'}</span>
            </div>
            <div className="info-row">
